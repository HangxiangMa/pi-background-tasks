...
| --- | --- | --- | --- |
| command | `bg` | `command:bg` | `src/extension.ts:554` |
| command | `bg-clear` | `command:bg-clear` | `src/extension.ts:596` |
| command | `bg-tasks` | `command:bg-tasks` | `src/extension.ts:588` |
| command | `bg-update` | `command:bg-update` | `src/extension.ts:604` |
| command | `claude-cache` | `command:claude-cache` | `src/core/anthropic-attribution.ts:3206` |
...
| command | `jobs` | `command:jobs` | `src/extension.ts:642` |
| command | `kill` | `command:kill` | `src/extension.ts:686` |
| command | `logs` | `command:logs` | `src/extension.ts:655` |
| command | `tasks` | `command:tasks` | `src/extension.ts:580` |
| tool | `bg_delegate` | `tool:bg_delegate` | `src/delegate-extension.ts:340` |
| tool | `bg_kill` | `tool:bg_kill` | `src/extension.ts:945` |
| tool | `bg_logs` | `tool:bg_logs` | `src/extension.ts:900` |
| tool | `bg_result` | `tool:bg_result` | `src/delegate-extension.ts:516` |
| tool | `bg_run` | `tool:bg_run` | `src/extension.ts:719` |
| tool | `bg_run_pi_attested` | `tool:bg_run_pi_attested` | `src/extension.ts:804` |
| tool | `bg_status` | `tool:bg_status` | `src/extension.ts:869` |
...
| shortcut | `ctrl+alt+c` | `shortcut:ctrl+alt+c` | `src/extension.ts:634` |
| shortcut | `shift+down` | `shortcut:shift+down` | `src/extension.ts:627` |
| renderer | `background-task-notification` | `renderer:background-task-notification` | `src/extension.ts:450` |
