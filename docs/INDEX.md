...
| --- | --- | --- | --- | --- | --- |
| command | `bg` | `command:bg` | `always` | yes | `src/extension.ts:743` |
| command | `bg-clear` | `command:bg-clear` | `always` | yes | `src/extension.ts:786` |
| command | `bg-tasks` | `command:bg-tasks` | `always` | yes | `src/extension.ts:778` |
| command | `bg-update` | `command:bg-update` | `always` | yes | `src/extension.ts:794` |
| command | `claude-cache` | `command:claude-cache` | `feature:attribution` | yes | `src/core/anthropic-attribution.ts:3206` |
| command | `fusion` | `command:fusion` | `feature:fusion` | yes | `src/fusion-extension.ts:996` |
| command | `fusion-models` | `command:fusion-models` | `feature:fusion` | yes | `src/fusion-extension.ts:1029` |
| command | `jobs` | `command:jobs` | `always` | yes | `src/extension.ts:843` |
| command | `kill` | `command:kill` | `always` | yes | `src/extension.ts:887` |
| command | `logs` | `command:logs` | `always` | yes | `src/extension.ts:856` |
| command | `tasks` | `command:tasks` | `always` | yes | `src/extension.ts:770` |
| tool | `bg_delegate` | `tool:bg_delegate` | `feature:delegate` | yes | `src/delegate-extension.ts:343` |
| tool | `bg_kill` | `tool:bg_kill` | `always` | yes | `src/extension.ts:1173` |
| tool | `bg_logs` | `tool:bg_logs` | `always` | yes | `src/extension.ts:1128` |
| tool | `bg_result` | `tool:bg_result` | `any(feature:delegate,feature:fusion)` | yes | `src/delegate-extension.ts:530` |
| tool | `bg_run` | `tool:bg_run` | `always` | yes | `src/extension.ts:920` |
| tool | `bg_run_pi_attested` | `tool:bg_run_pi_attested` | `feature:attested` | yes | `src/extension.ts:1029` |
| tool | `bg_status` | `tool:bg_status` | `always` | yes | `src/extension.ts:1097` |
| tool | `fusion_investigate` | `tool:fusion_investigate` | `feature:fusion` | yes | `src/fusion-extension.ts:1197` |
| tool | `fusion_reason` | `tool:fusion_reason` | `feature:fusion` | yes | `src/fusion-extension.ts:1179` |
| tool | `fusion_research` | `tool:fusion_research` | `feature:fusion` | yes | `src/fusion-extension.ts:1216` |
| tool | `fusion_validate` | `tool:fusion_validate` | `feature:fusion` | yes | `src/fusion-extension.ts:1236` |
| shortcut | `ctrl+alt+b` | `shortcut:ctrl+alt+b` | `dock:ctrl+alt+b` | no | `src/extension.ts:827` |
| shortcut | `ctrl+alt+c` | `shortcut:ctrl+alt+c` | `always` | yes | `src/extension.ts:835` |
| shortcut | `shift+down` | `shortcut:shift+down` | `dock:shift+down` | yes | `src/extension.ts:818` |
| renderer | `background-task-notification` | `renderer:background-task-notification` | `always` | yes | `src/extension.ts:620` |
| renderer | `fusion-result` | `renderer:fusion-result` | `feature:fusion` | yes | `src/fusion-extension.ts:980` |
