...
| --- | --- | --- | --- | --- | --- |
| command | `bg` | `command:bg` | `always` | yes | `src/extension.ts:534` |
| command | `bg-clear` | `command:bg-clear` | `always` | yes | `src/extension.ts:576` |
| command | `bg-tasks` | `command:bg-tasks` | `always` | yes | `src/extension.ts:568` |
| command | `bg-update` | `command:bg-update` | `always` | yes | `src/extension.ts:584` |
...
| command | `jobs` | `command:jobs` | `always` | yes | `src/extension.ts:633` |
| command | `kill` | `command:kill` | `always` | yes | `src/extension.ts:677` |
| command | `logs` | `command:logs` | `always` | yes | `src/extension.ts:646` |
| command | `tasks` | `command:tasks` | `always` | yes | `src/extension.ts:560` |
| tool | `bg_delegate` | `tool:bg_delegate` | `feature:delegate` | yes | `src/delegate-extension.ts:343` |
| tool | `bg_kill` | `tool:bg_kill` | `always` | yes | `src/extension.ts:939` |
| tool | `bg_logs` | `tool:bg_logs` | `always` | yes | `src/extension.ts:894` |
| tool | `bg_result` | `tool:bg_result` | `any(feature:delegate,feature:fusion)` | yes | `src/delegate-extension.ts:530` |
| tool | `bg_run` | `tool:bg_run` | `always` | yes | `src/extension.ts:710` |
| tool | `bg_run_pi_attested` | `tool:bg_run_pi_attested` | `feature:attested` | yes | `src/extension.ts:796` |
| tool | `bg_status` | `tool:bg_status` | `always` | yes | `src/extension.ts:863` |
...
| shortcut | `ctrl+alt+b` | `shortcut:ctrl+alt+b` | `dock:ctrl+alt+b` | no | `src/extension.ts:617` |
| shortcut | `ctrl+alt+c` | `shortcut:ctrl+alt+c` | `always` | yes | `src/extension.ts:625` |
| shortcut | `shift+down` | `shortcut:shift+down` | `dock:shift+down` | yes | `src/extension.ts:608` |
| renderer | `background-task-notification` | `renderer:background-task-notification` | `always` | yes | `src/extension.ts:443` |
