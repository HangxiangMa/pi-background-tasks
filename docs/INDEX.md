...
| --- | --- | --- | --- | --- | --- |
| command | `bg` | `command:bg` | `always` | yes | `src/extension.ts:574` |
| command | `bg-clear` | `command:bg-clear` | `always` | yes | `src/extension.ts:616` |
| command | `bg-tasks` | `command:bg-tasks` | `always` | yes | `src/extension.ts:608` |
| command | `bg-update` | `command:bg-update` | `always` | yes | `src/extension.ts:624` |
...
| command | `jobs` | `command:jobs` | `always` | yes | `src/extension.ts:673` |
| command | `kill` | `command:kill` | `always` | yes | `src/extension.ts:717` |
| command | `logs` | `command:logs` | `always` | yes | `src/extension.ts:686` |
| command | `tasks` | `command:tasks` | `always` | yes | `src/extension.ts:600` |
| tool | `bg_delegate` | `tool:bg_delegate` | `feature:delegate` | yes | `src/delegate-extension.ts:343` |
| tool | `bg_kill` | `tool:bg_kill` | `always` | yes | `src/extension.ts:979` |
| tool | `bg_logs` | `tool:bg_logs` | `always` | yes | `src/extension.ts:934` |
| tool | `bg_result` | `tool:bg_result` | `any(feature:delegate,feature:fusion)` | yes | `src/delegate-extension.ts:530` |
| tool | `bg_run` | `tool:bg_run` | `always` | yes | `src/extension.ts:750` |
| tool | `bg_run_pi_attested` | `tool:bg_run_pi_attested` | `feature:attested` | yes | `src/extension.ts:836` |
| tool | `bg_status` | `tool:bg_status` | `always` | yes | `src/extension.ts:903` |
...
| shortcut | `ctrl+alt+b` | `shortcut:ctrl+alt+b` | `dock:ctrl+alt+b` | no | `src/extension.ts:657` |
| shortcut | `ctrl+alt+c` | `shortcut:ctrl+alt+c` | `always` | yes | `src/extension.ts:665` |
| shortcut | `shift+down` | `shortcut:shift+down` | `dock:shift+down` | yes | `src/extension.ts:648` |
| renderer | `background-task-notification` | `renderer:background-task-notification` | `always` | yes | `src/extension.ts:483` |
