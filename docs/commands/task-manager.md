...
| --- | --- | --- | --- | --- |
| `/tasks` | `always` | yes | Open the Claude-like background task manager UI | `src/extension.ts:604` |
| `/bg-tasks` | `always` | yes | Open the background task manager UI | `src/extension.ts:612` |
