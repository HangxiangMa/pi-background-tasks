...
| --- | --- | --- | --- | --- |
| `/tasks` | `always` | yes | Open the Claude-like background task manager UI | `src/extension.ts:600` |
| `/bg-tasks` | `always` | yes | Open the background task manager UI | `src/extension.ts:608` |
