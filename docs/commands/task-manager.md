...
| --- | --- | --- | --- | --- |
| `/tasks` | `always` | yes | Open the Claude-like background task manager UI | `src/extension.ts:770` |
| `/bg-tasks` | `always` | yes | Open the background task manager UI | `src/extension.ts:778` |
