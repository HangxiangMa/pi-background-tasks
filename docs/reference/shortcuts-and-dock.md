...
| --- | --- | --- |
| `ctrl+alt+c` | Clear finished background task footer notices (terminal-dependent fallback for /bg-clear) | `src/extension.ts:634` |
| `shift+down` | Open focused background task footer dock | `src/extension.ts:627` |
