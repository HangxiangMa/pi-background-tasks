...
| `Path` | read | `src/core/common.ts:681` |
| `PATH` | read | `src/core/common.ts:681`<br>`src/core/pi-launch.ts:425` |
...
| `PI_BG_DISABLE_UPDATE_CHECK` | read | `src/extension.ts:472` |
...
| `PI_BG_REGISTRY_URL` | read | `src/extension.ts:481` |
...
| `PI_OFFLINE` | read | `src/extension.ts:473` |
