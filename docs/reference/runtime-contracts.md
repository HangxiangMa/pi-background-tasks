...
| `ComSpec` | read | `src/core/common.ts:729`<br>`src/core/common.ts:740` |
...
| `path` | read | `src/core/common.ts:684` |
| `Path` | read | `src/core/common.ts:684` |
| `PATH` | read | `src/core/common.ts:684` |
...
| `PI_BG_DISABLE_PI_TELEMETRY` | read | `src/core/registry.ts:227` |
| `PI_BG_DISABLE_UPDATE_CHECK` | read | `src/extension.ts:462` |
| `PI_BG_MAX_OUTPUT_BYTES` | read | `src/core/registry.ts:69` |
| `PI_BG_REGISTRY_URL` | read | `src/extension.ts:471` |
| `PI_BG_SHELL` | read | `src/core/common.ts:725` |
| `PI_BG_SHELL_PATH` | read | `src/core/common.ts:726` |
...
| `PI_OFFLINE` | read | `src/extension.ts:463` |
...
| `SHELL` | read | `src/core/common.ts:721` |
...
| directory | `.pi/tasks/<session-id>-<pid>/` | `src/core/registry.ts:845` |
...
| task-file | `.pi/tasks/<session-id>-<pid>/<task-id>.json` | `src/core/registry.ts:945` |
| task-file | `.pi/tasks/<session-id>-<pid>/<task-id>.output` | `src/core/registry.ts:944` |
