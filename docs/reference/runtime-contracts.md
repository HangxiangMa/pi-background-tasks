...
| `ComSpec` | read | `src/core/common.ts:1050`<br>`src/core/common.ts:1068` |
...
| `path` | read | `src/core/common.ts:966` |
| `Path` | read | `src/core/common.ts:966` |
| `PATH` | read | `src/core/common.ts:1020`<br>`src/core/common.ts:966`<br>`src/core/pi-launch.ts:425` |
| `PI_ANTHROPIC_ACCOUNT_CONFIG_PATH` | read | `src/core/anthropic-attribution.ts:1026` |
...
| `PI_BG_POSIX_SHELL` | read | `src/core/common.ts:1088` |
| `PI_BG_POSIX_SHELL_PATH` | read | `src/core/common.ts:1098` |
| `PI_BG_REGISTRY_URL` | read | `src/extension.ts:665` |
| `PI_BG_SHELL` | read | `src/core/common.ts:1045` |
| `PI_BG_SHELL_PATH` | read | `src/core/common.ts:1046` |
| `PI_CACHE_RETENTION` | read, write | `src/core/anthropic-attribution.ts:791`<br>`src/core/anthropic-attribution.ts:802`<br>`src/core/fusion/claude-cache.ts:57`<br>`src/core/fusion/pi-child.ts:273`<br>`src/core/fusion/pi-child.ts:274` |
...
| `PIPELINE_ANTHROPIC_ATTRIBUTION_AUDIT_PATH` | read | `src/core/anthropic-attribution.ts:1303` |
| `SHELL` | read | `src/core/common.ts:1105` |
